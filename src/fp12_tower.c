...
void mul_fp12_vector(vec384fp12 ret, const vec384fp12 a, const vec384fp12 b)
{
  ...
  for (i = 0; i < SWORDS; i++) {
    t[0][0][i] = VSET( b[1][0][0][i], a[1][0][0][i], 
                       b[0][0][0][i], a[1][0][0][i], 
                       b[1][0][0][i], a[0][0][0][i], 
                       b[0][0][0][i], a[0][0][0][i]);
    t[0][1][i] = VSET( b[1][0][1][i], a[1][0][1][i], 
                       b[0][0][1][i], a[1][0][1][i], 
                       b[1][0][1][i], a[0][0][1][i], 
                       b[0][0][1][i], a[0][0][1][i]);
    t[1][0][i] = VSET( b[1][1][0][i], a[1][1][0][i], 
                       b[0][1][0][i], a[1][1][0][i], 
                       b[1][1][0][i], a[0][1][0][i], 
                       b[0][1][0][i], a[0][1][0][i]);
    t[1][1][i] = VSET( b[1][1][1][i], a[1][1][1][i], 
                       b[0][1][1][i], a[1][1][1][i], 
                       b[1][1][1][i], a[0][1][1][i], 
                       b[0][1][1][i], a[0][1][1][i]);
    t[2][0][i] = VSET( b[1][2][0][i], a[1][2][0][i], 
                       b[0][2][0][i], a[1][2][0][i], 
                       b[1][2][0][i], a[0][2][0][i], 
                       b[0][2][0][i], a[0][2][0][i]);
    t[2][1][i] = VSET( b[1][2][1][i], a[1][2][1][i], 
                       b[0][2][1][i], a[1][2][1][i], 
                       b[1][2][1][i], a[0][2][1][i], 
                       b[0][2][1][i], a[0][2][1][i]);    
  }
...
void cyclotomic_sqr_fp12_vector(vec384fp12 ret, const vec384fp12 a)
{
  ...
  for (i = 0; i < SWORDS/2; i++) {
    ...
    uint64_t *t = (uint64_t *) &t_1x2x2x2w[i];
    t[7] = a[1][1][1][i+SWORDS/2];
    t[6] = a[1][1][1][i         ];
    t[5] = a[1][1][0][i+SWORDS/2];
    t[4] = a[1][1][0][i         ];
    t[3] = a[0][0][1][i+SWORDS/2];
    t[2] = a[0][0][1][i         ];
    t[1] = a[0][0][0][i+SWORDS/2];
    t[0] = a[0][0][0][i         ];
  }
  ...
  for (i = 0; i < SWORDS; i++) {
    ...
    //                       a[0][2][1][i], a[0][2][0][i], 
    //                       a[1][0][1][i], a[1][0][0][i] );
    uint64_t *t = (uint64_t *) &t_2x2x2x1w[i];
    t[7] = a[1][2][1][i];
    t[6] = a[1][2][0][i];
    t[5] = a[0][1][1][i];
    t[4] = a[0][1][0][i];
