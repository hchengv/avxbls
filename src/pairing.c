...
static void raise_to_z_div_by_2(vec384fp12 ret, const vec384fp12 a)
{
  ...
  for (i = 0; i < SWORDS; i++) {
    _t[0][0][i] = VSET( s[1][1][0][1][i], s[1][1][0][0][i],
                        s[0][1][0][1][i], s[0][1][0][0][i],
                        s[1][0][0][1][i], s[1][0][0][0][i],
                        s[0][0][0][1][i], s[0][0][0][0][i]);
    _t[0][1][i] = VSET( s[1][1][1][1][i], s[1][1][1][0][i],
                        s[0][1][1][1][i], s[0][1][1][0][i],
                        s[1][0][1][1][i], s[1][0][1][0][i],
                        s[0][0][1][1][i], s[0][0][1][0][i]);
    _t[0][2][i] = VSET( s[1][1][2][1][i], s[1][1][2][0][i],
                        s[0][1][2][1][i], s[0][1][2][0][i],
                        s[1][0][2][1][i], s[1][0][2][0][i],
                        s[0][0][2][1][i], s[0][0][2][0][i]);
  }

  conv_64to48_fp_8x1w(ab0[0], _t[0][0]);
  conv_64to48_fp_8x1w(ab1[0], _t[0][1]);
  conv_64to48_fp_8x1w(ab2[0], _t[0][2]);

  for (i = 0; i < SWORDS; i++) {
    _t[1][0][i] = VSET( s[3][1][0][1][i], s[3][1][0][0][i],
                        s[2][1][0][1][i], s[2][1][0][0][i],
                        s[3][0][0][1][i], s[3][0][0][0][i],
                        s[2][0][0][1][i], s[2][0][0][0][i]);
    _t[1][1][i] = VSET( s[3][1][1][1][i], s[3][1][1][0][i],
                        s[2][1][1][1][i], s[2][1][1][0][i],
                        s[3][0][1][1][i], s[3][0][1][0][i],
                        s[2][0][1][1][i], s[2][0][1][0][i]);
    _t[1][2][i] = VSET( s[3][1][2][1][i], s[3][1][2][0][i],
                        s[2][1][2][1][i], s[2][1][2][0][i],
                        s[3][0][2][1][i], s[3][0][2][0][i],
                        s[2][0][2][1][i], s[2][0][2][0][i]);
  }

  conv_64to48_fp_8x1w(ab0[1], _t[1][0]);
  conv_64to48_fp_8x1w(ab1[1], _t[1][1]);
  conv_64to48_fp_8x1w(ab2[1], _t[1][2]);

  for (i = 0; i < SWORDS; i++) {
    _t[2][0][i] = VSET( s[5][1][0][1][i], s[5][1][0][0][i],
                        s[4][1][0][1][i], s[4][1][0][0][i],
                        s[5][0][0][1][i], s[5][0][0][0][i],
                        s[4][0][0][1][i], s[4][0][0][0][i]);
    _t[2][1][i] = VSET( s[5][1][1][1][i], s[5][1][1][0][i],
                        s[4][1][1][1][i], s[4][1][1][0][i],
                        s[5][0][1][1][i], s[5][0][1][0][i],
                        s[4][0][1][1][i], s[4][0][1][0][i]);
    _t[2][2][i] = VSET( s[5][1][2][1][i], s[5][1][2][0][i],
                        s[4][1][2][1][i], s[4][1][2][0][i],
                        s[5][0][2][1][i], s[5][0][2][0][i],
                        s[4][0][2][1][i], s[4][0][2][0][i]);
  }

  conv_64to48_fp_8x1w(ab0[2], _t[2][0]);
  conv_64to48_fp_8x1w(ab1[2], _t[2][1]);
  conv_64to48_fp_8x1w(ab2[2], _t[2][2]);
  ...
  conv_48to64_fp_4x2w(_t[0][0], r001[3]);
  conv_48to64_fp_4x2w(_t[0][1], r101[3]);
  conv_48to64_fp_4x2w(_t[0][2], r2[3]);

  for (i = 0; i < SWORDS/2; i++) {
    ret[0][0][0][i         ] = ((uint64_t *)&_t[0][0][i])[0];
    ret[0][0][0][i+SWORDS/2] = ((uint64_t *)&_t[0][0][i])[1];
    ret[0][0][1][i         ] = ((uint64_t *)&_t[0][0][i])[2];
    ret[0][0][1][i+SWORDS/2] = ((uint64_t *)&_t[0][0][i])[3];
    ret[0][1][0][i         ] = ((uint64_t *)&_t[0][0][i])[4];
    ret[0][1][0][i+SWORDS/2] = ((uint64_t *)&_t[0][0][i])[5];
    ret[0][1][1][i         ] = ((uint64_t *)&_t[0][0][i])[6];
    ret[0][1][1][i+SWORDS/2] = ((uint64_t *)&_t[0][0][i])[7];
    ret[1][0][0][i         ] = ((uint64_t *)&_t[0][1][i])[0];
    ret[1][0][0][i+SWORDS/2] = ((uint64_t *)&_t[0][1][i])[1];
    ret[1][0][1][i         ] = ((uint64_t *)&_t[0][1][i])[2];
    ret[1][0][1][i+SWORDS/2] = ((uint64_t *)&_t[0][1][i])[3];
    ret[1][1][0][i         ] = ((uint64_t *)&_t[0][1][i])[4];
    ret[1][1][0][i+SWORDS/2] = ((uint64_t *)&_t[0][1][i])[5];
    ret[1][1][1][i         ] = ((uint64_t *)&_t[0][1][i])[6];
    ret[1][1][1][i+SWORDS/2] = ((uint64_t *)&_t[0][1][i])[7];
    ret[0][2][0][i         ] = ((uint64_t *)&_t[0][2][i])[0];
    ret[0][2][0][i+SWORDS/2] = ((uint64_t *)&_t[0][2][i])[1];
    ret[0][2][1][i         ] = ((uint64_t *)&_t[0][2][i])[2];
    ret[0][2][1][i+SWORDS/2] = ((uint64_t *)&_t[0][2][i])[3];
    ret[1][2][0][i         ] = ((uint64_t *)&_t[0][2][i])[4];
    ret[1][2][0][i+SWORDS/2] = ((uint64_t *)&_t[0][2][i])[5];
    ret[1][2][1][i         ] = ((uint64_t *)&_t[0][2][i])[6];
    ret[1][2][1][i+SWORDS/2] = ((uint64_t *)&_t[0][2][i])[7];
  }
